...
function updateData(){
    ...
    var obj={"name":""+name,"email":""+email,"contact":""+contact,"address":""+address,"image":""+image};
...
function changeDP(){
    ...
    document.getElementById("profile").setAttribute("src","images/"+document.getElementById("image").value);
}
